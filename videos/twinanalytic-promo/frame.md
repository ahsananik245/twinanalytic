...
description: >
  ...
  identical and sacred — the site palette, Playfair Display 400 headings + Sora body + JetBrains Mono numerals, the
...
typography:
  # — reading ramp (Sora) —
  body:        { fontFamily: "Sora", cqw: 1.0,  weight: 400, lineHeight: 1.6, color: "text-secondary" }
  body-sm:     { fontFamily: "Sora", cqw: 0.85, weight: 400, lineHeight: 1.6 }
  subtitle:    { fontFamily: "Sora", cqw: 1.3,  weight: 400, lineHeight: 1.5 }
  label:       { fontFamily: "JetBrains Mono", px: 14, weight: 500, tracking: "3px", upper: true, color: "accent" }
  attribution: { fontFamily: "JetBrains Mono", px: 15, weight: 400, tracking: "2px", upper: true, color: "accent" }
  micro:       { fontFamily: "JetBrains Mono", px: 12, weight: 400, tracking: "2px", upper: true, color: "accent" }
  ...
  stat-figure: { fontFamily: "JetBrains Mono", cqw: 3.0, weight: 400, lineHeight: 1.0 }
...
- **Fonts** — **Playfair Display** headings, **Sora** body, **JetBrains Mono** labels and
  numerals, matching twinanalytic.com. Ignore any preset font name lingering in prose.
...
- **Playfair Display 400** (ink, sentence case) for display; **Playfair Display** body (gray) + labels (taupe, tracked).
...
Two ramps. The **reading ramp** (Playfair Display body 1.0cqw gray, labels in px taupe) carries copy + chrome;
...
- **Playfair at 400, ink, sentence case** — never bold, never uppercase, never taupe. **Playfair Display labels uppercase, 2–3px tracked, taupe.** Italic via Playfair italic for emphasis only.

## Depth & Surface

The flat plane is the only technique. Hierarchy from:

- **Type contrast** — Playfair serif vs Playfair Display sans; the 8cqw→0.7cqw scale.
...
- **Playfair Display + Playfair Display via Google Fonts.** CJK pairing (Noto Serif SC 700/400) carries over; Playfair has no Hanzi italic — substitute weight/taupe for emphasis.
