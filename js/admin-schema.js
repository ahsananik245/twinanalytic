      ...
      cards: [
        {
          ...
          fields: [
            ...
            { key: 'concreteTexture', label: 'Show the concrete texture behind the site', type: 'toggle', wide: true,
              hint: 'A real concrete surface behind every page, tinted to the site background so it adds depth without changing the colour. Turn both this and the grid off for a flat background.' },
